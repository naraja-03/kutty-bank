        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <label className="block text-sm font-medium text-gray-300">Family Members</label>
              <button
                type="button"
            ...
            <div className="space-y-3">
              {formData.members.map((member, index) => (
                <div
                  key={`member-${index}-${member.email || member.name || index}`}
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="relative flex-1">
                          ...
                          <div className="absolute right-2 top-2">{getRoleIcon(member.role)}</div>
                        </div>
                        <button
                          type="button"
