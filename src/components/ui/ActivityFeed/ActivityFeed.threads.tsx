        ...
        {!isLoading && transactions.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              Share your first transaction with the family. Every expense and income will appear
              here like a chat!
            </p>
              ...
              >
                ...
                <div
                  className={clsx(
                    ...
                    isCurrentUser ? 'bg-blue-600 text-white ml-12' : 'bg-gray-800 text-white mr-12'
                  )}
                >
                  {!isCurrentUser && (
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-col space-y-1">
                      ...
                      <span className="text-xs text-gray-300">{transaction.category}</span>
                    </div>

                    {transaction.note && (
                      <p className="text-sm text-gray-100">{transaction.note}</p>
                    )}
