...
import { CheckCircle, IndianRupee, TrendingUp } from 'lucide-react';
      ...
      >
        ...
        <div className={`border rounded-xl p-6 mb-6 ${
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-2">
            ...
            <div className={`${budgetStatus.color} font-medium text-sm sm:text-base`}>
          ...
          <div className="space-y-4">
            ...
            {/* Remaining Balance */}
            {remainingBalance !== 0 && (
              <div className={`flex flex-col sm:flex-row sm:justify-between sm:items-center p-4 rounded-lg border gap-2 ${
                remainingBalance > 0 
                  ? theme === 'dark' 
