...
export const EssentialsStep = ({ onNext, onPrev, isFirstStep }: EssentialsStepProps) => {
  ...
  const canProceed = !budget.isOverBudget;
      ...
      >
        ...
        {budget.totalIncome > 0 && (
          <AvailableBalance
            ...
            usedAmount={formData.essentials.totalEssentials}
        ...
        {budget.isOverBudget && (
          <div className={`mt-4 p-4 rounded-xl border ${
            ...
            <div className={`text-sm font-medium ${
              ...
              ⚠️ Budget Exceeded: You&apos;re spending {budget.totalSpendingPercentage.toFixed(1)}% of your income
            </div>
